...
function FileShareForm({ file, onPasswordSave }) {
    ...
    return file && (
        <div className='flex flex-col gap-2'>
            ...
            <div className='gap-3 flex mt-5 text-black'>
                <input type='checkbox'
            ...
            {isPasswordEnable ?
                <div className='flex gap-3 items-center '>
                    <div className='border rounded-md w-full p-2 text-black '>
                        <input type="password"
                            defaultValue={file.password}
                            className='disabled:text-gray-500
                 outline-none' onChange={(e) => setPassword(e.target.value)} />
                    </div>
                    <button className='p-2 bg-primary text-black
            ...
            <div className='border rounded-md p-3 mt-5 text-black'>
                <label className='text-[14px] text-gray-600'>Send File to Email</label>
                ...
                <button className='p-2 disabled:bg-gray-300
                 bg-primary text-gray-400 hover:bg-blue-600
